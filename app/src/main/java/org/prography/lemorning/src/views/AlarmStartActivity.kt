...
class AlarmStartActivity : BaseActivity<ActivityAlarmStartBinding, PlayAlarmViewModel>(R.layout.activity_alarm_start) {
    ...
    class PlaySongViewModelFactory(var songNo: Int, val application: Application) : ViewModelProvider.Factory {
        override fun <T : ViewModel?> create(modelClass: Class<T>): T = PlayAlarmViewModel(songNo, application) as T
    }
