...
class TimePickerSlider(context: Context)
    ...
    private fun initView(context: Context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            btnSubmit.apply {
                tag = TAG_SUBMIT
                typeface = ResourcesCompat.getFont(context, org.prography.lemorning.R.font.noto_medium)
            ...
            btnCancel.apply {
                tag = TAG_CANCEL
                typeface = ResourcesCompat.getFont(context, org.prography.lemorning.R.font.noto_regular)
                includeFontPadding = false
                letterSpacing = 0f
                text =
