...
public class CircleVisualizerSmooth extends BaseVisualizer {
    ...
    public CircleVisualizerSmooth(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public CircleVisualizerSmooth(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
